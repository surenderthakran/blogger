...
externals.render = () => {
  ...
  const html = mustache.render(index, {
    ...
    head_content: fs.readFileSync(__root + '/views/templates/partials/head_content.html', 'utf8'),
    header: fs.readFileSync(__root + '/views/templates/partials/header.html', 'utf8')
  });
